...
public class ApiPartnerBankAdapter implements LenderBankPort {
    static final String BANK_LIST_PATH = ApiPartnerOpenApiPaths.BANK_LIST;
    static final String BUSINESS_TYPE = "REFERENCE_BANK_LIST";

    private final ApiPartnerHttpClient httpClient;

    public ApiPartnerBankAdapter(ApiPartnerHttpClient httpClient) {
