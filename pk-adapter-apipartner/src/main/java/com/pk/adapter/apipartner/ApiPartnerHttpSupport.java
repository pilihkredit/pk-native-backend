...
final class ApiPartnerHttpSupport {
    ...
    private static void redactSensitiveNode(JsonNode node) {
        ...
        if (node.isArray()) {
            node.forEach(ApiPartnerHttpSupport::redactSensitiveNode);
        }
    }
    ...
    static ApiException mapFailureCode(String responseCode, String responseMsg) {
        ...
        return ApiPartnerLenderCodeMapper.toApiException(
                responseCode,
