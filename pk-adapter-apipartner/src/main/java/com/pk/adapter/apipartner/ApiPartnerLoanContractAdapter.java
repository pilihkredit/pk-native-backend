...
public class ApiPartnerLoanContractAdapter implements LenderLoanContractPort {
    static final String CONTRACT_LIST_PATH = ApiPartnerOpenApiPaths.LOAN_CONTRACT_LIST;
    static final String BUSINESS_TYPE = "LOAN_CONTRACT_LIST";

    private final ApiPartnerHttpClient httpClient;
    private final ObjectMapper objectMapper;

    public ApiPartnerLoanContractAdapter(ApiPartnerHttpClient httpClient, ObjectMapper objectMapper) {
    ...
    public LenderLoanContractListResult listContracts(String loanApplyId) {
        String requestBody = ApiPartnerLoanRequestMapper.buildContractListBody(loanApplyId);
