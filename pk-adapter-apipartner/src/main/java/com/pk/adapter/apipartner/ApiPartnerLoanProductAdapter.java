...
public class ApiPartnerLoanProductAdapter implements LenderLoanProductPort {
    static final String PRODUCT_LIST_PATH = ApiPartnerOpenApiPaths.PRODUCT_LIST;
    static final String BUSINESS_TYPE = "LOAN_PRODUCT_LIST";

    private final ApiPartnerHttpClient httpClient;
    private final ObjectMapper objectMapper;

    public ApiPartnerLoanProductAdapter(ApiPartnerHttpClient httpClient, ObjectMapper objectMapper) {
