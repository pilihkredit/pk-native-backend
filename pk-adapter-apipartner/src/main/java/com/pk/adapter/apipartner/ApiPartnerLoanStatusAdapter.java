...
public class ApiPartnerLoanStatusAdapter implements LenderLoanStatusPort {
    static final String APPLY_STATUS_PATH = ApiPartnerOpenApiPaths.LOAN_APPLY_STATUS;
    static final String BUSINESS_TYPE = "LOAN_APPLY_STATUS";

    private final ApiPartnerHttpClient httpClient;
    private final ObjectMapper objectMapper;

    public ApiPartnerLoanStatusAdapter(ApiPartnerHttpClient httpClient, ObjectMapper objectMapper) {
    ...
    public LenderLoanStatusResult queryStatus(String loanApplyId) {
        String requestBody = ApiPartnerLoanRequestMapper.buildStatusBody(loanApplyId);
