...
public class ApiPartnerProfileQueryAdapter implements LenderProfileQueryPort {
    static final String USER_INFO_QUERY_PATH = ApiPartnerOpenApiPaths.USER_INFO_QUERY;
    static final String BUSINESS_TYPE = "PROFILE_INFO_QUERY";

    private final ApiPartnerHttpClient httpClient;
    private final ObjectMapper objectMapper;

    public ApiPartnerProfileQueryAdapter(ApiPartnerHttpClient httpClient, ObjectMapper objectMapper) {
