...
final class ApiPartnerProfileUpsertMapper {
    private ApiPartnerProfileUpsertMapper() {
    }
    ...
    static void applyDevice(ObjectNode userInfo, com.pk.core.profile.sync.LenderDeviceContext device) {
        userInfo.set("device", ApiPartnerDeviceNodeBuilder.buildProfileSyncDevice(device));
    }
}
