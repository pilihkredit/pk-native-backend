...
@ConfigurationProperties(prefix = "pk.lender.apipartner")
public class ApiPartnerProperties {
    ...
    public void validateHttpSettings() {
        ...
        if (!httpCredentialsPresent()) {
            throw new IllegalStateException(
                    "pk.lender.apipartner.base-url, client-id, client-secret, and app-name are required when mode=http"
            );
        }
    }
