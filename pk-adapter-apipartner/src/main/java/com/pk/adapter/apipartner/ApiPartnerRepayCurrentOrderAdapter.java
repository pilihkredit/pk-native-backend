...
public class ApiPartnerRepayCurrentOrderAdapter implements LenderRepayCurrentOrderPort {
    static final String REPAY_CURRENT_ORDER_PATH = ApiPartnerOpenApiPaths.REPAY_CURRENT_ORDER;
    static final String BUSINESS_TYPE = "REPAY_CURRENT_ORDER";

    private final ApiPartnerHttpClient httpClient;
    private final ObjectMapper objectMapper;

    public ApiPartnerRepayCurrentOrderAdapter(ApiPartnerHttpClient httpClient, ObjectMapper objectMapper) {
