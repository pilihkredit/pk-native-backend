...
public class ApiPartnerServerEventCallbackParser implements ServerEventCallbackParser {
    private final ObjectMapper objectMapper;

    public ApiPartnerServerEventCallbackParser(ObjectMapper objectMapper) {
