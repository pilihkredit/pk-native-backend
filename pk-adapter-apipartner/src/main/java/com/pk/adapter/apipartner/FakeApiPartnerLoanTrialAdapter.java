...
public class FakeApiPartnerLoanTrialAdapter implements LenderLoanTrialPort {
    public FakeApiPartnerLoanTrialAdapter(com.fasterxml.jackson.databind.ObjectMapper ignored) {
    }

    public FakeApiPartnerLoanTrialAdapter() {
    }
