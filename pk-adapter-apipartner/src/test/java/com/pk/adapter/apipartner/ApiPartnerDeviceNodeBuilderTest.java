...
class ApiPartnerDeviceNodeBuilderTest {
    private final ObjectMapper objectMapper = new ObjectMapper();

    @Test
    void riskApplyDeviceAlwaysIncludesDeviceOtherInfoObject() throws Exception {
        String body = ApiPartnerCreditRequestMapper.buildApplyBody(new LenderCreditPort.LenderCreditApplyCommand(
                "apply-1",
                "partner-1",
                null,
                null,
    ...
    void profileSyncDeviceOmitsEmptyDeviceOtherInfo() {
        JsonNode device = ApiPartnerDeviceNodeBuilder.buildProfileSyncDevice(sampleDevice(null));
    ...
    void loanApplyOmitsAppListForIos() throws Exception {
        String body = ApiPartnerLoanRequestMapper.buildApplyBody(new LenderLoanApplyPort.LenderLoanApplyCommand(
                "apply-1",
                "loan-1",
                null,
                "product-1",
