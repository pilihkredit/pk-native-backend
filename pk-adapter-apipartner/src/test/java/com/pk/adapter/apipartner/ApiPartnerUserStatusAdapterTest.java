...
class ApiPartnerUserStatusAdapterTest {
    @Mock
    ...
    void mapsLenderUserStatusResponse() throws Exception {
        ...
        ApiPartnerUserStatusAdapter adapter = new ApiPartnerUserStatusAdapter(httpClient, objectMapper);
        when(httpClient.postWithInteraction(
                eq(ApiPartnerUserStatusAdapter.USER_STATUS_PATH),
                org.mockito.ArgumentMatchers.anyString(),
                eq(ApiPartnerUserStatusAdapter.BUSINESS_TYPE),
                eq("U10001")
