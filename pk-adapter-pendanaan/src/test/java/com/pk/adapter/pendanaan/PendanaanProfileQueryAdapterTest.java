...
class PendanaanProfileQueryAdapterTest {
    @Mock
    ...
    void mapsLenderProfileQueryResponse() throws Exception {
        ...
        PendanaanProfileQueryAdapter adapter = new PendanaanProfileQueryAdapter(httpClient, objectMapper);
        when(httpClient.post(
                eq(PendanaanProfileQueryAdapter.USER_INFO_QUERY_PATH),
                org.mockito.ArgumentMatchers.anyString(),
                eq(PendanaanProfileQueryAdapter.BUSINESS_TYPE),
                eq("U10001")
