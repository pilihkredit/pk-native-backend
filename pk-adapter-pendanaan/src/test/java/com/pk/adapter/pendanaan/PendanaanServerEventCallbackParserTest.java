...
class PendanaanServerEventCallbackParserTest {
    private PendanaanServerEventCallbackParser parser;

    @BeforeEach
    void setUp() {
        parser = new PendanaanServerEventCallbackParser(new ObjectMapper());
    }
