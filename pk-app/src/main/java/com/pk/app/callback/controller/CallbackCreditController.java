...
@PublicApi
public class CallbackCreditController {
    private final CallbackApplicationService callbackApplicationService;

    public CallbackCreditController(CallbackApplicationService callbackApplicationService) {
    ...
    public ApiResponse<Void> receiveResult(
        ...
        callbackApplicationService.receiveCreditResult(accessToken, rawPayloadJson);
