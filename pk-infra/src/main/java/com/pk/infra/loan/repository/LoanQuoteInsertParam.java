...
public class LoanQuoteInsertParam {
    ...
    private String productCode; private String repayMethod; private BigDecimal applyAmt; private BigDecimal loanPrincipal;
    private BigDecimal payAmount; private BigDecimal schdAmount; private BigDecimal interest; private Integer totalDays;
    private String feeJson; private String rawResponseJson; private Instant quotedAt;
    public static LoanQuoteInsertParam from(LoanQuoteInsert c){LoanQuoteInsertParam p=new LoanQuoteInsertParam();
    p.quoteNo=c.quoteNo();p.creditApplicationId=c.creditApplicationId();p.productSnapshotId=c.productSnapshotId();
    ...
    p.feeJson=c.feeJson();p.rawResponseJson=c.rawResponseJson();p.quotedAt=c.quotedAt();return p;}
