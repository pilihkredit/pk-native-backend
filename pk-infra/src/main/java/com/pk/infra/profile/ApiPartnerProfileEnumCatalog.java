...
/**
 * Canonical profile enum catalog aligned with ApiPartner OpenAPI v1.1.0.
 */
public class ApiPartnerProfileEnumCatalog implements ProfileEnumCatalog {
    ...
    public ApiPartnerProfileEnumCatalog() {
        this.fields = List.of(
