...
/**
 * Pendanaan OpenAPI uses the same integer enum codes as the app catalog today.
 */
public class PendanaanLenderEnumMapper implements LenderEnumMapper {
    public static final String PROVIDER_CODE = "pendanaan";

    private final ProfileEnumCatalog profileEnumCatalog;

    public PendanaanLenderEnumMapper(ProfileEnumCatalog profileEnumCatalog) {
