...
import com.pk.core.repay.port.LoanBillReadRepository.TrialBackfillCandidate;
...
@Mapper
public interface LoanBillReadMapper {
    ...
    List<TrialBackfillCandidate> findDueForTrialBackfill(
            @Param("afterLoanApplicationId") long afterLoanApplicationId,
