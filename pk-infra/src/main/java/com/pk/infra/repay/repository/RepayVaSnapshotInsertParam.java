...
public class RepayVaSnapshotInsertParam {
    ...
    public RepayVaSnapshotInsertParam(long profileId,String snapshotNo,String vaNo,String bankCode,String bankName,boolean defaultFlag,boolean disabled,String bankChannelsJson,Instant fetchedAt){
        this.profileId=profileId;this.snapshotNo=snapshotNo;this.vaNo=vaNo;this.bankCode=bankCode;this.bankName=bankName;
        this.defaultFlag=defaultFlag;this.disabled=disabled;this.bankChannelsJson=bankChannelsJson;this.fetchedAt=fetchedAt;}
