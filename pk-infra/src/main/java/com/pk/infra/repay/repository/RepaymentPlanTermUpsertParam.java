...
public class RepaymentPlanTermUpsertParam {
    ...
    public static RepaymentPlanTermUpsertParam of(long loanApplicationId,String loanApplyId,String billNo,TermUpsert term,Instant syncedAt){
        ...
        p.overdueDays=term.overdueDays();p.amountDetailJson=term.amountDetailJson();p.lastRepayTime=term.lastRepayTime();p.syncedAt=syncedAt;return p;}
