...
class LoanBillsFacadeTest {
    ...
    void syncsActiveBillsFromLenderAndUpsertsByLoanApplyId() {
        ...
        assertThat(saved.contrNo()).isEqualTo("CTR-LOAN-1");
        assertThat(saved.shouldPrincipal()).isEqualByComparingTo("250000");
        assertThat(saved.shouldInterest()).isEqualByComparingTo("45000");
