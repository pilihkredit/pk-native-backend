...
CREATE TABLE user_profile (
    ...
    password_set_at DATETIME(3) NULL COMMENT 'First password setup time',
    password_changed_at DATETIME(3) NULL COMMENT 'Latest password change time',
    last_login_at DATETIME(3) NULL COMMENT 'Latest successful login time',
    last_login_device_no VARCHAR(128) NULL COMMENT 'Device id from last successful password/OTP/WhatsApp login',
...
CREATE TABLE user_mobile_change_face_verification (
    id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary key',
...
CREATE TABLE review_guide_exposure (
    id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary key',
    user_id BIGINT UNSIGNED NOT NULL COMMENT 'user_profile.id',
