...
CREATE TABLE loan_quote (
    ...
    mobile_no VARCHAR(32) NOT NULL COMMENT 'Account owner mobile number',
    product_list_id BIGINT UNSIGNED NULL COMMENT 'pk_lender_product_list.id',
    ...
    day_rate DECIMAL(18,6) NULL COMMENT 'Daily interest rate',
    show_day_rate DECIMAL(18,6) NULL COMMENT 'Displayed daily interest rate',
    ...
    ad_reduction_ratio DECIMAL(18,6) NULL COMMENT 'Early settlement reduction ratio',
...
CREATE TABLE loan_quote_term (
    ...
    value_date DATETIME(3) NULL COMMENT 'Value date',
